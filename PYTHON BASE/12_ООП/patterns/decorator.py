# Декоратор -- это не встроенная особенность питона, а паттерн проектирования доступный в любом ЯП.
# В питоне есть удобный синтаксис, чтобы немного упростить работу с декораторами.
# Суть этого паттерна в оборачивании функции, другой функцией.
