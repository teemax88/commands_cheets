```python
# Функция zip() в Python - это встроенная функция, которая используется для объединения (сопоставления) элементов 
# из разных последовательностей в пары или кортежи.
